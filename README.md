# Xoasn - Build a Cursor AI Alternative
...
Xoasn is a browser-based IDE inspired by Cursor AI, featuring:
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/code-with-antonio/xoasn.git
   cd xoasn
   ```
...
4. Configure your `.env.local` with the required keys:
   ...
   CONVEX_DEPLOYMENT=
   XOASN_CONVEX_INTERNAL_KEY=  # Generate a random string
