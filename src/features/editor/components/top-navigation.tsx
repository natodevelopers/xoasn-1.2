...
const Tab = ({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center gap-2 h-8.75 pl-2 pr-1.5 cursor-pointer text-muted-foreground group border-y border-x border-transparent hover:bg-accent/30 transition-all duration-200",
        isActive &&
    ...
    >
      ...
      <button
        ...
        className={cn(
          "p-0.5 rounded-sm hover:bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-200",
