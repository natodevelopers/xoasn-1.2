        ...
        <div className="flex-1 h-full flex items-center px-3 bg-background border-x text-xs text-muted-foreground truncate font-mono">
          {isLoading && (
            <div className="flex items-center gap-1.5">
              <Ring size="12" stroke="2" bgOpacity="0" speed="2" color="currentColor" />
        ...
        <Allotment vertical>
          <Allotment.Pane>
            ...
            {isLoading && !error && (
              <div className="size-full flex items-center justify-center text-muted-foreground">
                <div className="flex flex-col items-center gap-2 max-w-md mx-auto text-center">
                  <Ring size="40" stroke="5" bgOpacity="0" speed="2" color="currentColor" />
            ...
            {previewUrl && (
              <iframe
                ...
                title="Preview"
                allow="autoplay; microphone; camera; midi; encrypted-media; clipboard-read; clipboard-write"
